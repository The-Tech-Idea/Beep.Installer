...
public class PayloadPrepareStep : ISetupStep
{
    ...
    public IErrorsInfo Execute(SetupContext context, IProgress<PassedArgs>? progress = null)
    {
        ...
        // Resolve relative paths against the primary config/exe directory.
        var primaryRoot = searchBases[0];
        context.Properties["PayloadRoot"] = primaryRoot;
        return StepErrorHelpers.Ok($"No local payload found — resolving relative paths against: {primaryRoot}");
    }
