...
{
    /// <summary>
    /// DI registration for the WinForms update experience. It simply forwards to the BeepDM
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddBeepAppUpdatesWinform(this IServiceCollection services, string? settingsPath = null)
            => services.AddBeepAppUpdates(settingsPath);

        /// <summary>Registers app self-update with explicit settings.</summary>
        public static IServiceCollection AddBeepAppUpdatesWinform(this IServiceCollection services, UpdateSettings settings)
